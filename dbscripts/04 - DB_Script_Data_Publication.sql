...
insert into `publication_subcategory` (`category_id`, `subcategory_id`, `description`, `common_state_id`) values('2','1','Cuadernos','A');
insert into `publication_subcategory` (`category_id`, `subcategory_id`, `description`, `common_state_id`) values('2','2','Lapiceras','A');
/*
SQLyog Enterprise - MySQL GUI
MySQL - 5.6.11 
*********************************************************************
...
insert into `publication_vote` (`vote_id`, `publication_id`, `user_id`) values('3','133','3');
/*
SQLyog Enterprise - MySQL GUI
MySQL - 5.6.11 
*********************************************************************
